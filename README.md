...
└── data/
    ├── Scout_Agent_Results/          # Raw CVE data
    ├── triage_agent_result/          # Analyzed CVE list
    ├── publisher_agent_result/       # Executive JSON Feed
    ├── Reports/                      # Final PDF briefings
    └── MAMORE/                       # Deduplication tracking
```
...
@misc{alsmadi2026autocti,
  ...
  howpublished = {\url{https://github.com/your-username/auto-cti}}
}
```
